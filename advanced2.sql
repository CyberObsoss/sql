...
join Artists_Album a2 on Artists.id_artist = Artists_Album.id_artist_aa
join Albums on Albums.id_album = Artists_Album.id_album_aa
where artist_name not in (select artist_name from Artists_Album where album_release_year >= '2020.01.01' and album_release_year < '2021.01.01');
...
join Artists on Artists_Alb um.id_artist_aa = Artists.id_artist
where artist_name like 'Taylor Swift';
